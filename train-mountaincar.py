...
class ActorCritic:
  def __init__(self, in_features=3, out_features=3, hidden_state=HIDDEN_UNITS):
...
if __name__ == "__main__":
  ...
  try:
    state_dict = safe_load('mountain.safetensors')
    load_state_dict(model, state_dict)
    print("checkpoint loaded..")
  except FileNotFoundError:
    print("checkpoint not found, creating new one..")
    safe_save(state_dict, 'mountain.safetensors')
